...
class UserTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_team" do
    assert_difference('UserTeam.count') do
      post user_teams_url, params: { user_team: { project_id: @user_team.project_id, user_id: @user_team.user_id } }
    end
  ...
  test "should update user_team" do
    patch user_team_url(@user_team), params: { user_team: { project_id: @user_team.project_id, user_id: @user_team.user_id } }
