...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post faqs_url, params: { faq: { answer: @faq.answer, excerpt: @faq.excerpt, title: @faq.title } }
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { answer: @faq.answer, excerpt: @faq.excerpt, title: @faq.title } }
