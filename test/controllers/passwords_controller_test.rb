...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { key: @password.key, name: @password.name, team_id: @password.team_id } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { key: @password.key, name: @password.name, team_id: @password.team_id } }
